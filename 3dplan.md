...
If you want, I can also show a **much stronger version of this planning prompt used in large agentic builds**, where the model produces:

* a **machine-readable build plan**
* **task graphs for agents**
* **file-by-file implementation specs**

That version tends to work **significantly better with Codex** for large projects.
